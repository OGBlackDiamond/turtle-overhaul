...
parser.add_argument("-c", "--coordinates", type=int, nargs=3, default=[0, 0, 0], help="The 3 coordinate points the first turtle will start at.")

# allows the user to define a new world
parser.add_argument("-w", "--world", type=str, default="world", help="The world name to create or load in.")
